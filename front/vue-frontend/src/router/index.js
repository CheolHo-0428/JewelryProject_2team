...
router.beforeEach((to, from, next) => {
  const publicPages = ['/login', '/signup', '/', '/mypage', '/notice', '/ring', '/earrings', '/bracelet', '/necklace', '/detail', '/cart', '/order', '/order_', '/orderlist', '/orderdetail', '/ordercancle', '/modify', '/regnotice', '/notice_', '/review_', '/qna_', '/admember', '/adminpage', '/adproduct', '/regproduct', '/adorder', '/adorder_', '/searchid', '/searchpw', '/findid', '/findpw', '/regreview', '/regqna', '/adsales', '/admember_', '/adproduct_']
